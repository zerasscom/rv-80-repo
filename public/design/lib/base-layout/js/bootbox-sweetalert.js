(function (global, factory) {
    ...
    window.fileDelete = function (result) {
        if (result) {
            document.getElementsByName('table-form-action')[0].submit();
        }else{
    ...
    window.formAction = function (result) {
        if (result) {
            document.getElementsByName('table-form-action')[0].submit();
        }else{
    ...
    window.massFormSubmit = function (result) {
        if (result) {
            document.getElementsByName('mass-form')[0].submit();
        }else{
            document.getElementById("mass").value = '';
        }
    };

    window.softDelete = function (result) {
        if (result) {
            document.getElementsByName('_type')[0].value=1;document.getElementsByName('table-form')[0].submit();
        }
    };

    window.restoreDelete = function (result) {
        if (result) {
            document.getElementsByName('_type')[0].value=3;document.getElementsByName('table-form')[0].submit();
        }
    };

    window.forceDelete = function (result) {
        if (result) {
            document.getElementsByName('_type')[0].value=4;document.getElementsByName('table-form')[0].submit();
        }
    };
